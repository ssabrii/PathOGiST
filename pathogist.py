...
def correlation(param):
    ...
    clustering = pathogist.cluster.correlation(distance_matrix,param.threshold,param.all_constraints,param.solver,param.method, param.presolve)
...
def main():
    ...
    corr_parser.add_argument("-s","--solver",type=str,choices=['cplex','pulp'],default='pulp',
                             help="LP solver interface to use")
    corr_parser.add_argument("-m","--method",type=str,choices=['C4','ILP','C4+ILP'],default='C4+ILP',
