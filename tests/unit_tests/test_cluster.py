...
class ClusterTest(unittest.TestCase):
    ...
    def setUp(self):
        mlst_dist_path = 'test_data/cluster/yersinia_mlst_dist.tsv'
        snp_dist_path = 'test_data/cluster/yersinia_snp_dist.tsv'
        kwip_dist_path = 'test_data/cluster/yersinia_kwip_dist.tsv'
        ...
        mlst_clust_path = 'test_data/cluster/yersinia_mlst_clustering.tsv'
        snp_clust_path = 'test_data/cluster/yersinia_snp_clustering.tsv'
        kwip_clust_path = 'test_data/cluster/yersinia_kwip_clustering.tsv'
    ...
    def test_correlation(self):
        true_clustering_path = 'test_data/cluster/yersinia_true_clustering.tsv'
    ...
    def test_consensus(self):
        ...
        true_clustering_path = 'test_data/cluster/yersinia_consensus_clustering.tsv'
        true_clustering = pathogist.io.open_clustering_file(true_clustering_path)
        samples = list(clustering.index.values)
